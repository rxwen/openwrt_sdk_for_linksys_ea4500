...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/mnt/dl/slave/kirkwood/build/staging_dir/host/bin/grep -E"}
	: ${FGREP="/mnt/dl/slave/kirkwood/build/staging_dir/host/bin/grep -F"}
	: ${GREP="/mnt/dl/slave/kirkwood/build/staging_dir/host/bin/grep"}
	: ${SED="/mnt/dl/slave/kirkwood/build/staging_dir/host/bin/sed"}
fi
