/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/dl/slave/kirkwood/build/build_dir/toolchain-arm_xscale_gcc-5.2.0_musl-1.1.12_eabi/gcc-5.2.0/gcc/config/arm/arm.md'.  */
